...
public interface BinarySearchProblems {
  ...
  /**
   * Return a solution for the Time Based Key-Value Store problem.
   *
   * @return a {@link TimeMap} implementation
   */
  TimeMap getTimeMap();
   ...
   *
   * <p>Implement the TimeMap class:
   *
   * <p>TimeMap() Initializes the object of the data structure. void set(String key, String value,
   * int timestamp) Stores the key key with the value value at the given time timestamp. String
